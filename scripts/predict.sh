...
cp $OUTPUT_DIR/test_results.txt $OUTPUT_DIR/test_results_WM.txt

CUDA_VISIBLE_DEVICES=1 /home/conda/talhindi/envs/claim-detection/bin/python /home/nlp-text/dynamic/talhindi/src/bert/run_token_classification.py \
...
CUDA_VISIBLE_DEVICES=1 /home/conda/talhindi/envs/claim-detection/bin/python /home/nlp-text/dynamic/talhindi/src/bert_weighted_loss_claim/run_token_classification.py \
--data_dir /home/nlp-text/dynamic/talhindi/data_newsplit/SG_WM/ \
--labels /home/nlp-text/dynamic/talhindi/data_newsplit/SG_WM/labels.txt \
--model_name_or_path $BERT_MODEL \
--output_dir $OUTPUT_DIR \
...
CUDA_VISIBLE_DEVICES=1 /home/conda/talhindi/envs/claim-detection/bin/python /home/nlp-text/dynamic/talhindi/src/bert_imho/run_token_classification.py \
...
export MAX_LENGTH=256
export BERT_MODEL=bert-base-cased
export OUTPUT_DIR=/home/nlp-text/dynamic/talhindi/models2/bert_claim_SG_old
export BATCH_SIZE=8
export NUM_EPOCHS=3
export SAVE_STEPS=0
export SEED=1
...
export MAX_LENGTH=256
export BERT_MODEL=bert-base-cased
export OUTPUT_DIR=/home/nlp-text/dynamic/talhindi/models2/bert_claim_SG
export BATCH_SIZE=8
export NUM_EPOCHS=3
export SAVE_STEPS=0
export SEED=1
...
export MAX_LENGTH=256
export BERT_MODEL=bert-base-cased
export OUTPUT_DIR=/home/nlp-text/dynamic/talhindi/models2/bert_claim_weightedloss_SG
export BATCH_SIZE=8
export NUM_EPOCHS=3
export SAVE_STEPS=0
export SEED=1
...
export MAX_LENGTH=256
export BERT_MODEL=bert-base-uncased
export OUTPUT_DIR=/home/nlp-text/dynamic/talhindi/models2/bert_claim_imho_SG
export BATCH_SIZE=8
export NUM_EPOCHS=3
export SAVE_STEPS=0
export SEED=1
